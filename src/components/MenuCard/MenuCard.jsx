...
export default function MenuCard({ item, quantity, onAdd, onChangeQuantity }) {
  return (
    <article className="menu-card grid min-h-[150px] grid-cols-[38%_minmax(0,1fr)] overflow-hidden rounded-[var(--radius-lg)] border border-[#f0e5d4] bg-ginger-surface p-0 shadow-ginger-card max-[359px]:min-h-[142px] max-[359px]:grid-cols-[35%_minmax(0,1fr)] md:min-h-[180px] md:grid-cols-[39%_minmax(0,1fr)] lg:min-h-[190px]">
      ...
      <div className="menu-card__content flex min-w-0 flex-col pt-5 pr-[13px] pb-2.5 pl-3.5 max-[359px]:pt-[15px] max-[359px]:pr-2.5 max-[359px]:pb-2 max-[359px]:pl-[11px] md:pt-[15px] md:pr-[15px] md:pb-3 md:pl-[18px]">
        ...
        <p className="menu-card__description mt-[7px] mb-2 line-clamp-2 overflow-hidden text-ginger-muted text-[clamp(.7rem,3vw,.9rem)] leading-[1.4] max-[359px]:text-[.68rem] md:text-[.92rem]">{item.description}</p>
